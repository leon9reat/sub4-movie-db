...
import com.medialink.sub4moviedb.model.error.ErrorRespon
import com.medialink.sub4moviedb.model.tv_show.TvShowRespon
import com.medialink.sub4moviedb.network.RetrofitClient
...
class TvShowRepository : TvShowDataSource {
    ...
    override fun getTvShows(callback: OperationCallback) {
        call = RetrofitClient.getTvApi().getTvPopular(page, language)
